...
class NizanimFormFiller(FormFillerBase):
    def __init__(self):
        self._url = r'https://docs.google.com/forms/d/e/1FAIpQLSfAvKwgmcsKnz_O1HeugXShuNxjpi8ZGt9fjAT4XwsZoOiJBw/viewform?fbzx=8545976520998916086'
        ...
        self._xpaths = OrderedDict(
            {'email': '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[1]/div[1]/div[2]/div[1]/div/div[1]/input',
             ...
             'date': '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[1]/div/div/div[2]/div/div/div[2]/div[1]/div/div[1]/input',
             # 'hebrew_child_first_name': '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[3]/div/div/div[2]/div/div[1]/div/div[1]/input',
             'hebrew_child_first_name': '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[1]/div/div/div[2]/div/div[1]/div/div[1]/input',
             # 'hebrew_child_last_name': '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[4]/div/div/div[2]/div/div[1]/div/div[1]/input',
             'hebrew_child_last_name': '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[2]/div/div/div[2]/div/div[1]/div/div[1]/input',
             # 'gan': '//*[@id="i22"]/div[3]/div',
             'gan': '//*[@id="i18"]/div[3]/div',
             # 'child_id': '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[6]/div/div/div[2]/div/div[1]/div/div[1]/input',
             'child_id': '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[3]/div/div/div[2]/div/div[1]/div/div[1]/input',
             # 'hebrew_parent_name': '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[7]/div/div/div[2]/div/div[1]/div/div[1]/input',
             'hebrew_parent_name': '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[5]/div/div/div[2]/div/div[1]/div[2]/textarea',
             'parent_id': '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[6]/div/div/div[2]/div/div[1]/div/div[1]/input',
             'phone_number': '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[8]/div/div/div[2]/div/div[1]/div/div[1]/input',
             # 'below_38': '//*[@id="i57"]/div[2]',
             'below_38': '//*[@id="i49"]/div[2]',
             # 'cough': '//*[@id="i60"]/div[2]',
             'cough': '//*[@id="i52"]/div[2]',
             # 'in_contact': '//*[@id="i63"]/div[2]',
             'in_contact': '//*[@id="i55"]/div[2]',
             # 'remark': '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[10]/div/div/div[2]/div/div[1]/div[2]/textarea',
             'remark': '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[8]/div/div/div[2]/div/div[1]/div[2]/textarea',
